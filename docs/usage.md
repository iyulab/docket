...
Returns `{"identity": ..., "candidates": [identity, ...]}`. Same exact segment rule, no similarity
scoring — but **no `unserved` gate and no `unserved` field**, unlike the topic version: a
